...
<p><em>Telecommunications Engineer from the <a href="https://www.uvigo.gal/es">University of Vigo</a><img src="https://media.giphy.com/media/fYSnHlufseco8Fh93Z/giphy.gif" width="30"></br>
</em></p>
...
const ruben = {
  ...
  tools: [Git, Node, Tomcat, MongoDB, Angular, MLFlow, Linux]
  learning: [PyTorch, Azure, AWS, Rust]
}
```
